...
private String token_np;
	...
	public void ct7(){
		...
		WebElement bntEdit = driver.findElement(By.id("u_ps_jsonp_2_0_5"));
		bntEdit.click();
		...
		WebElement postEdit = driver.findElement(By.cssSelector("_5_jv _58jw")); 
		postEdit.sendKeys(getMessageUserAlter());
